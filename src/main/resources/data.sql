insert into item(id, price, name, short_description, description, img_address) VALUES
  ...
  'Pizza Margherita to klasyka włoskiej kuchni. W naszym wydaniu serwujemy pizzę na cienkim cieście z ' ||
   'ręcznie przygotowanym sosem pomidorowym i oryginalnym serem mozarella', '/img/image/1.jpg'),
  ...
  'Idealna propozycja dla każdego miłośnika pasty. Spaghetti bolognese w naszym wykonaniu to ręcznie przygotowany ' ||
   'makaron z sosem pomidorowym oraz wysokiej jakości wołowiną. Do przygotowania sosu wykorzystujemy pomidory z ' ||
    'lokalnych upraw oraz świeże zioła.', '/img/image/3.jpg'),
  ...
  'Masz ochodę na coś słodkiego? Ta propozycja to nasza interpretacja jednego z najbardziej rozpoznawalnych włoskich' ||
   'deserów. Przygotowujemy go ze śmietanki BIO, świeżego mleka i prawdziwej wanilii. Na życzenie deser podajemy ' ||
    'w alternatywnej wersji z sosem czekoladowym.', '/img/image/4.jpg'),
  (5, 39.99, 'Ciasto Igusi', 'Ciasteczko dla mojego koteczka',
  'Masz ochotę na słodyczkę? Ta propozycja to nasza interpretacja jednego z najbardziej rozpoznawalnych włoskich ' ||
   'deserów. Przygotowujemy go ze śmietanki BIO, świeżego mleczka dla koteczka i prawdziwej wanilii. Na życzenie deser ' ||
    'podajemy w alternatywnej wersji z sosem czekoladowym.', '/img/image/4.jpg');
